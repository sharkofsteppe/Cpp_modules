...
void    ClapTrap::showConditions( void ) const
{
    std::cout << "ClapTrap: " << _Name << std::endl << "Hitpoints: " << _Hitpoints << std::endl << "Energy Points: " << _EnergyPoints << std::endl << "Attack Damage: " << _AttackDamage << std::endl;
}
